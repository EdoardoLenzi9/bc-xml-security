        ...
        public void ImportKeyNode()
        {
            ...
            foreach (var clause in info)
            {
                ...
                else if (clause is DsaKeyValue)
                {
                    ...
                    Assert.Equal(Convert.FromBase64String(dsaQ), dsaParams.Q.ToByteArrayUnsigned());
                    ...
                    if (seed != null)
                    {
                        Assert.Equal(Convert.FromBase64String(dsaSeed), seed);
                        ...
                        Assert.Equal(counterVal, dsaParams.ValidationParameters.Counter);
                    }
                    else
                    {
                        Assert.Null(seed);
