...
namespace Org.BouncyCastle.Crypto.Xml.Tests
{
    ...
    public class KeyInfoX509DataTest
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new KeyInfoX509Data(null, Enumerable.Empty<X509Certificate>(), X509IncludeOption.EndCertOnly));
        }
        ...
        public void InvalidKeyNode3()
        {
            ...
            doc.LoadXml(bad);
            KeyInfoX509Data data1 = new KeyInfoX509Data();
            Assert.Throws<System.Security.Cryptography.CryptographicException>(() => data1.LoadXml(doc.DocumentElement));
        }
    }
}
