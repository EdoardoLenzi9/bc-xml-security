...
namespace Org.BouncyCastle.Crypto.Xml.Tests
{
    ...
    public class SignedXmlTest
    {
        ...
        public void Constructor_Empty()
        {
            ...
            SignatureChecker sx = new SignatureChecker(doc);
            sx.LoadXml(xel);
        ...
        public void AsymmetricRSAMixedCaseAttributesVerifyWindows()
        {
            ...
            SignatureChecker v1 = new SignatureChecker();
        ...
        public void AsymmetricRSAVerify()
        {
            ...
            SignatureChecker v2 = new SignatureChecker();
            ...
            SignatureChecker v3 = new SignatureChecker();
        ...
        public void GetPublicKey()
        {
            ...
            AsymmetricKeyParameter aa1 = sxe.PublicGetPublicKey();
            Assert.True((aa1 is RsaKeyParameters), "First Public Key is RSA");

            AsymmetricKeyParameter aa2 = sxe.PublicGetPublicKey();
            Assert.Null(aa2);
        }
        ...
        {
            SignedXml sx = new SignedXml();
            Assert.Throws<System.Security.Cryptography.CryptographicException>(() => sx.GetXml());
        }
        ...
        {
            SignatureChecker sx = new SignatureChecker();
            Assert.True(!sx.CheckSignature());
        }
        ...
        public void DigestValue_CRLF()
        {
            ...
            x509KeyInfo.AddCertificate(new X509CertificateParser().ReadCertificate(_cert));
        ...
        public void SignedXML_CRLF_Invalid()
        {
            ...
            SignatureChecker signedXml = new SignatureChecker(doc);
        ...
        {
            SignatureChecker signedXml = new SignatureChecker(signedDoc);
        ...
        public SignedXml SignHMAC(string uri, IMac mac, bool expectedToVerify)
        {
            ...
            SignatureChecker sig = new SignatureChecker(doc);
        ...
        static SignatureChecker GetSignedXml(string xml)
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(xml);
        ...
        static void CheckErratum(SignatureChecker signed, IMac hmac, string message)
        {
            if (erratum)
            {
