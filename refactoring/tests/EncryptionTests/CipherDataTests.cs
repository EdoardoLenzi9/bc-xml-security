...
namespace Org.BouncyCastle.Crypto.Xml.Tests
{
    public class CipherDataTests
    {
        ...
        public void Constructor_Empty()
        {
            ...
            Assert.Throws<System.Security.Cryptography.CryptographicException>(() => cipherData.GetXml());
        }
        ...
        public void CipherReference_CipherValueSet()
        {
            ...
            Assert.Throws<System.Security.Cryptography.CryptographicException>(() => cipherData.CipherReference = new CipherReference());
        }
        ...
        public void LoadXml_NoValueOrReference()
        {
            ...
            Assert.Throws<System.Security.Cryptography.CryptographicException>(() => cipherData.LoadXml(xmlDocument.DocumentElement));
        }
